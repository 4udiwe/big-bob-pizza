...
type (
	...
	Kafka struct {
		...
		Topics  struct {
			PaymentEvents  string `env-required:"true" yaml:"payment_events"`
			KitchenEvents  string `env-required:"true" yaml:"kitchen_events"`
			DeliveryEvents string `env-required:"true" yaml:"delivery_events"`
